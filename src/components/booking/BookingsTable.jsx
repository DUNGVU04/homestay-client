    ...
    if (startDate && endDate) {
      filtered = bookingInfo.filter((booking) => {
        ...
        return (
          ...
          bookingEndDate > startDate // Điều kiện này kiểm tra xem đặt phòng bắt đầu sau hoặc vào ngày startDate, kết thúc trước hoặc vào ngày endDate, và không nằm ngoài khoảng thời gian từ startDate đến endDate.
        );
      });
    }
